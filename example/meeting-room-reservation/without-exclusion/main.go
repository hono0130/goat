...
func createMeetingRoomWithoutExclusionModel() (*DBStateMachine, *ServerStateMachine, *ServerStateMachine, *ClientStateMachine, *ClientStateMachine, []goat.Option) {
	// === Database Spec ===
	...
	return db, server1, server2, client1, client2, opts
}

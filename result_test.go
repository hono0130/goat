...
func TestTest(t *testing.T) {
	t.Run("no violation", testTestNoViolation)
	t.Run("invariant violation", testTestInvariantViolation)
	t.Run("temporal violation", testTestTemporalViolation)
	t.Run("error on empty options", testTestError)
}

func testTestNoViolation(t *testing.T) {
...
func testTestInvariantViolation(t *testing.T) {
	sm := newTestStateMachine(newTestState("s"))
...
func testTestTemporalViolation(t *testing.T) {
	sm := newTestStateMachine(newTestState("s"))

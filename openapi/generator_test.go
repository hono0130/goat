	...
	tests := []struct {
	...
	}{
		{
			...
			setupSpec: func() *OpenAPIServiceSpec[*TestService1] {
				...
				OnOpenAPIEndpoint(spec, state, "POST", "/items", "createItem",
				...
				OnOpenAPIEndpoint(spec, state, "GET", "/items/{id}", "getItem",
...
`,
		},
		{
			...
			setupSpec: func() *OpenAPIServiceSpec[*TestService1] {
				...
				OnOpenAPIEndpoint(spec, state, "GET", "/health", "healthCheck",
					&TestRequest1{}, &TestResponse1{},
					func(ctx context.Context, event *TestRequest1, sm *TestService1) OpenAPIResponse[*TestResponse1] {
						return OpenAPISendTo(ctx, sm, &TestResponse1{})
					})
...
func TestGenerateOpenAPI_MultipleServices(t *testing.T) {
	...
	OnOpenAPIEndpoint(spec1, state1, "POST", "/service1/action", "service1Action",
		&TestRequest1{}, &TestResponse1{},
		func(ctx context.Context, event *TestRequest1, sm *TestService1) OpenAPIResponse[*TestResponse1] {
			return OpenAPISendTo(ctx, sm, &TestResponse1{})
		})
	...
	OnOpenAPIEndpoint(spec2, state2, "GET", "/service2/query", "service2Query",
		&TestRequest2{}, &TestResponse2{},
